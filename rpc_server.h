...
// The NCCL handlers run in the CUDA connection process: the same child owns
// the driver state the collectives operate on.
enum class rpc_backend { cuda, nvml, hip, nccl };
