...
CUresult cuDeviceGetName(char* name, int len, CUdevice dev)
{
    ...
    if (conn == nullptr ||
        ...
        rpc_read_end(conn) < 0)
        return CUDA_ERROR_DEVICE_UNAVAILABLE;
    if (return_value == CUDA_SUCCESS) lupine_mark_host_range_clean(name, len * sizeof(char));
    return return_value;
}
...
CUresult cuDeviceGetUuid(CUuuid* uuid, CUdevice dev)
{
    ...
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuDeviceGetUuid", &return_value, uuid, dev)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
        rpc_write_start_request(conn, RPC_cuDeviceGetUuid) < 0 ||
        rpc_write(conn, &dev, sizeof(CUdevice)) < 0 ||
        rpc_wait_for_response(conn) < 0 ||
        ...
        rpc_read_end(conn) < 0)
        return CUDA_ERROR_DEVICE_UNAVAILABLE;
    if (return_value == CUDA_SUCCESS) lupine_mark_host_range_clean(uuid, 16 * sizeof(CUuuid));
    return return_value;
}
...
CUresult cuDeviceGetUuid_v2(CUuuid* uuid, CUdevice dev)
{
    ...
    using real_fn_t = CUresult (*)(CUuuid*, CUdevice);
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuDeviceGetUuid_v2", &return_value, uuid, dev)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
...
CUresult cuDeviceGetLuid(char* luid, unsigned int* deviceNodeMask, CUdevice dev)
{
    ...
    if (conn == nullptr ||
        ...
        rpc_read_end(conn) < 0)
        return CUDA_ERROR_DEVICE_UNAVAILABLE;
    if (return_value == CUDA_SUCCESS) lupine_mark_host_range_clean(luid, 8 * sizeof(char));
    return return_value;
}
...
CUresult cuDeviceTotalMem_v2(size_t* bytes, CUdevice dev)
{
    ...
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuDeviceTotalMem_v2", &return_value, bytes, dev)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
...
CUresult cuDevicePrimaryCtxRetain(CUcontext* pctx, CUdevice dev)
{
    ...
    if (return_value == CUDA_SUCCESS) lupine_note_primary_context_active(dev);
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
...
CUresult cuDevicePrimaryCtxRelease_v2(CUdevice dev)
{
    ...
    if (return_value == CUDA_SUCCESS) lupine_invalidate_primary_context_state(dev);
...
CUresult cuDevicePrimaryCtxSetFlags_v2(CUdevice dev, unsigned int flags)
{
    ...
    if (return_value == CUDA_SUCCESS) lupine_note_primary_context_flags(dev, flags);
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
...
CUresult cuCtxCreate_v2(CUcontext* pctx, unsigned int flags, CUdevice dev)
{
    ...
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuCtxCreate_v2", &return_value, pctx, flags, dev)) {
    if (return_value == CUDA_SUCCESS && pctx != nullptr) {
        lupine_note_context_owner_route(*pctx, route);
    }
        return return_value;
...
CUresult cuCtxCreate_v3(CUcontext* pctx, CUexecAffinityParam* paramsArray, int numParams, unsigned int flags, CUdevice dev)
{
    lupine_route route = lupine_route_for_device(&dev);
    CUresult return_value;
    using real_fn_t = CUresult (*)(CUcontext*, CUexecAffinityParam*, int, unsigned int, CUdevice);
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuCtxCreate_v3", &return_value, pctx, paramsArray, numParams, flags, dev)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
        rpc_write_start_request(conn, RPC_cuCtxCreate_v3) < 0 ||
        rpc_write(conn, &numParams, sizeof(int)) < 0 ||
        rpc_write(conn, &flags, sizeof(unsigned int)) < 0 ||
        rpc_write(conn, &dev, sizeof(CUdevice)) < 0 ||
        rpc_wait_for_response(conn) < 0 ||
        (lupine_prepare_host_range_write(paramsArray, numParams * sizeof(CUexecAffinityParam)), false) ||
        rpc_read(conn, pctx, sizeof(CUcontext)) < 0 ||
        (numParams * sizeof(CUexecAffinityParam) != 0 && rpc_read(conn, paramsArray, numParams * sizeof(CUexecAffinityParam)) < 0) ||
        rpc_read(conn, &return_value, sizeof(CUresult)) < 0 ||
        rpc_read_end(conn) < 0)
        return CUDA_ERROR_DEVICE_UNAVAILABLE;
    if (return_value == CUDA_SUCCESS) lupine_mark_host_range_clean(paramsArray, numParams * sizeof(CUexecAffinityParam));
    return return_value;
}
...
CUresult cuModuleGetFunction(CUfunction* hfunc, CUmodule hmod, const char* name)
{
    ...
    if (return_value == CUDA_SUCCESS && hfunc != nullptr) return_value = lupine_record_module_function(*hfunc, hmod, name, route);
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
...
CUresult cuModuleGetGlobal_v2(CUdeviceptr* dptr, size_t* bytes, CUmodule hmod, const char* name)
{
    ...
    if (return_value == CUDA_SUCCESS && dptr != nullptr) lupine_note_deviceptr_allocation(*dptr, remote_bytes, conn);
    return return_value;
}
...
CUresult cuLibraryGetKernel(CUkernel* pKernel, CUlibrary library, const char* name)
{
    ...
    if (return_value == CUDA_SUCCESS && pKernel != nullptr) return_value = lupine_record_library_kernel(*pKernel, library, name, route);
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    std::size_t name_len = std::strlen(name) + 1;
...
CUresult cuKernelSetAttribute(CUfunction_attribute attrib, int val, CUkernel kernel, CUdevice dev)
{
    ...
    if (return_value == CUDA_SUCCESS) lupine_kernel_attribute_cache_erase(lupine_route_identity(route), kernel, (int)attrib, (int)dev);
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
...
{
    return lupine_cuKernelGetParamInfo_cached(kernel, paramIndex, paramOffset, paramSize);
}
...
CUresult cuDeviceGetPCIBusId(char* pciBusId, int len, CUdevice dev)
{
    ...
    if (conn == nullptr ||
        ...
        rpc_read_end(conn) < 0)
        return CUDA_ERROR_DEVICE_UNAVAILABLE;
    if (return_value == CUDA_SUCCESS) lupine_mark_host_range_clean(pciBusId, len * sizeof(char));
    return return_value;
}
...
CUresult cuMemPrefetchAsync(CUdeviceptr devPtr, size_t count, CUdevice dstDevice, CUstream hStream)
{
    ...
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuMemPrefetchAsync", &return_value, devPtr, count, dstDevice, hStream)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
...
CUresult cuMemAdvise(CUdeviceptr devPtr, size_t count, CUmem_advise advice, CUdevice device)
{
    ...
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuMemAdvise", &return_value, devPtr, count, advice, device)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
...
CUresult cuStreamUpdateCaptureDependencies(CUstream hStream, CUgraphNode* dependencies, size_t numDependencies, unsigned int flags)
{
    lupine_route route = (hStream != nullptr ? lupine_route_for_stream(hStream) : lupine_route_for_default());
    CUresult return_value;
    using real_fn_t = CUresult (*)(CUstream, CUgraphNode*, size_t, unsigned int);
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuStreamUpdateCaptureDependencies", &return_value, hStream, dependencies, numDependencies, flags)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
        rpc_write_start_request(conn, RPC_cuStreamUpdateCaptureDependencies) < 0 ||
        rpc_write(conn, &hStream, sizeof(CUstream)) < 0 ||
...
CUresult cuEventRecordWithFlags(CUevent hEvent, CUstream hStream, unsigned int flags)
{
    ...
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuEventRecordWithFlags", &return_value, hEvent, hStream, flags)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
...
CUresult cuEventQuery(CUevent hEvent)
{
    ...
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuEventQuery", &return_value, hEvent)) {
    if (return_value == CUDA_SUCCESS) return_value = lupine_sync_mapped_device_to_host();
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
...
CUresult cuEventElapsedTime(float* pMilliseconds, CUevent hStart, CUevent hEnd)
{
    ...
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuEventElapsedTime", &return_value, pMilliseconds, hStart, hEnd)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (conn == nullptr ||
        rpc_write_start_request(conn, RPC_cuEventElapsedTime) < 0 ||
...
{
    return lupine_cuFuncGetParamInfo_cached(func, paramIndex, paramOffset, paramSize);
}
...
CUresult cuGraphAddDependencies(CUgraph hGraph, const CUgraphNode* from, const CUgraphNode* to, size_t numDependencies)
{
    lupine_route route = lupine_route_for_graph(hGraph);
    CUresult return_value;
    using real_fn_t = CUresult (*)(CUgraph, const CUgraphNode*, const CUgraphNode*, size_t);
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuGraphAddDependencies", &return_value, hGraph, from, to, numDependencies)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (numDependencies * sizeof(const CUgraphNode) != 0 && from == nullptr)
        return CUDA_ERROR_DEVICE_UNAVAILABLE;
    if (numDependencies * sizeof(const CUgraphNode) != 0 && to == nullptr)
        return CUDA_ERROR_DEVICE_UNAVAILABLE;
    if (conn == nullptr ||
        rpc_write_start_request(conn, RPC_cuGraphAddDependencies) < 0 ||
        rpc_write(conn, &hGraph, sizeof(CUgraph)) < 0 ||
        rpc_write(conn, &numDependencies, sizeof(size_t)) < 0 ||
        (numDependencies * sizeof(const CUgraphNode) != 0 && rpc_write(conn, from, numDependencies * sizeof(const CUgraphNode)) < 0) ||
        (numDependencies * sizeof(const CUgraphNode) != 0 && rpc_write(conn, to, numDependencies * sizeof(const CUgraphNode)) < 0) ||
        rpc_wait_for_response(conn) < 0 ||
        rpc_read(conn, &return_value, sizeof(CUresult)) < 0 ||
        rpc_read_end(conn) < 0)
        return CUDA_ERROR_DEVICE_UNAVAILABLE;
...
CUresult cuGraphRemoveDependencies(CUgraph hGraph, const CUgraphNode* from, const CUgraphNode* to, size_t numDependencies)
{
    ...
    using real_fn_t = CUresult (*)(CUgraph, const CUgraphNode*, const CUgraphNode*, size_t);
    if (lupine_call_local_cuda_if_routed<real_fn_t>(
            route, "cuGraphRemoveDependencies", &return_value, hGraph, from, to, numDependencies)) {
        return return_value;
    }
    conn_t *conn = lupine_route_remote_conn(route);
    if (numDependencies * sizeof(const CUgraphNode) != 0 && from == nullptr)
    ...
    if (numDependencies * sizeof(const CUgraphNode) != 0 && to == nullptr)
        return CUDA_ERROR_DEVICE_UNAVAILABLE;
    if (conn == nullptr ||
        rpc_write_start_request(conn, RPC_cuGraphRemoveDependencies) < 0 ||
        rpc_write(conn, &hGraph, sizeof(CUgraph)) < 0 ||
        rpc_write(conn, &numDependencies, sizeof(size_t)) < 0 ||
        (numDependencies * sizeof(const CUgraphNode) != 0 && rpc_write(conn, from, numDependencies * sizeof(const CUgraphNode)) < 0) ||
        (numDependencies * sizeof(const CUgraphNode) != 0 && rpc_write(conn, to, numDependencies * sizeof(const CUgraphNode)) < 0) ||
...
{
    return lupine_cuOccupancyMaxActiveBlocksPerMultiprocessor_cached(numBlocks, func, blockSize, dynamicSMemSize);
}

CUresult cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(int* numBlocks, CUfunction func, int blockSize, size_t dynamicSMemSize, unsigned int flags)
{
    return lupine_cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags_cached(numBlocks, func, blockSize, dynamicSMemSize, flags);
}
...
#endif
extern "C" CUresult cuMemPrefetchAsync_ptsz(CUdeviceptr devPtr, size_t count, CUdevice dstDevice, CUstream hStream)
{
...
#endif
extern "C" CUresult cuStreamUpdateCaptureDependencies_ptsz(CUstream hStream, CUgraphNode* dependencies, size_t numDependencies, unsigned int flags)
{
    return cuStreamUpdateCaptureDependencies(hStream, dependencies, numDependencies, flags);
}
