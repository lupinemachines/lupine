...
/**
 * @recordowner CUBLAS_HANDLE handle
 * @param handle RECV_ONLY
 */
cublasStatus_t cublasCreate_v2(cublasHandle_t *handle);
/**
 * @release CUBLAS_HANDLE handle
 ...
 */
cublasStatus_t cublasGetEmulationStrategy(
    cublasHandle_t handle, cublasEmulationStrategy_t *emulationStrategy);
/**
 * @guard CUDA_VERSION >= 13030
 * @param handle SEND_ONLY
 * @param emulationStrategy SEND_ONLY
 */
cublasStatus_t cublasSetEmulationStrategy(
    cublasHandle_t handle, cublasEmulationStrategy_t emulationStrategy);
/**
 * @guard CUDA_VERSION >= 13030
 * @param handle SEND_ONLY
 ...
 */
cublasStatus_t cublasGetEmulationSpecialValuesSupport(
    cublasHandle_t handle, cudaEmulationSpecialValuesSupport *mask);
/**
 * @guard CUDA_VERSION >= 13030
 * @param handle SEND_ONLY
 * @param mask SEND_ONLY
 */
cublasStatus_t cublasSetEmulationSpecialValuesSupport(
    cublasHandle_t handle, cudaEmulationSpecialValuesSupport mask);
/**
 * @guard CUDA_VERSION >= 13030
 * @param handle SEND_ONLY
 ...
 */
cublasStatus_t cublasGetFixedPointEmulationMaxMantissaBitCount(
    cublasHandle_t handle, int *maxMantissaBitCount);
/**
 * @guard CUDA_VERSION >= 13030
 * @param handle SEND_ONLY
 * @param maxMantissaBitCount SEND_ONLY
 */
cublasStatus_t cublasSetFixedPointEmulationMaxMantissaBitCount(
    cublasHandle_t handle, int maxMantissaBitCount);
/**
 * @guard CUDA_VERSION >= 13030
 * @param handle SEND_ONLY
 ...
 */
cublasStatus_t cublasGetFixedPointEmulationMantissaBitOffset(
    cublasHandle_t handle, int *mantissaBitOffset);
/**
 * @guard CUDA_VERSION >= 13030
 * @param handle SEND_ONLY
 * @param mantissaBitOffset SEND_ONLY
 */
cublasStatus_t cublasSetFixedPointEmulationMantissaBitOffset(
    cublasHandle_t handle, int mantissaBitOffset);
/**
 * @guard CUDA_VERSION >= 13030
 * @param handle SEND_ONLY
 ...
 */
cublasStatus_t cublasGetFixedPointEmulationMantissaBitCountPointer(
    cublasHandle_t handle, int **mantissaBitCount);
/**
 * @guard CUDA_VERSION >= 13030
 * @param handle SEND_ONLY
 * @param mantissaBitCount SEND_ONLY
 */
cublasStatus_t cublasSetFixedPointEmulationMantissaBitCountPointer(
    cublasHandle_t handle, int *mantissaBitCount);
/**
 * @disabled
...
cublasStatus_t cublasSgemmGroupedBatched_64(
    ...
    const float alpha_array[], const float *const Aarray[],
    const int64_t lda_array[], const float *const Barray[],
    const int64_t ldb_array[], const float beta_array[],
    float *const Carray[], const int64_t ldc_array[], int64_t group_count,
...
cublasStatus_t cublasGemmGroupedBatchedEx_64(
    ...
    const void *const Aarray[], cudaDataType_t Atype,
    const int64_t lda_array[], const void *const Barray[],
    cudaDataType_t Btype, const int64_t ldb_array[], const void *beta_array,
    void *const Carray[], cudaDataType_t Ctype, const int64_t ldc_array[],
