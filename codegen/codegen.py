...
def infer_routing_key(
    ...
    for param in params:
        ...
        # call there.
        if type_name in ("cublasHandle_t", "cublasLtHandle_t"):
            return "HANDLE", param
    return None, None
...
def write_cuda_client(functions_with_annotations, legacy_abi_functions):
    with open("gen_cuda_client.cpp", "w") as f:
        f.write(
            ...
            'extern "C" void lupine_kernel_attribute_set_note(int route_id, CUkernel kernel, int attrib, int dev, int val);\n'
...
def main():
    ...
    write_rpc_ids(
        ...
        hip_functions_with_annotations,
        cudart_functions_with_annotations,
        cublas_functions_with_annotations + cublaslt_functions_with_annotations,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--verify-backend",
        choices=("all", "cuda", "cudart", "cublas", "cublaslt", "nvml", "hip"),
