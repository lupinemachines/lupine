...
lupine_manual_handlers() {
  static const std::unordered_map<int, lupine_manual_handler> handlers = {
      ...
      {LUPINE_RPC_lupineMappedDeviceRegister,
       {handle_manual_lupineMappedDeviceRegister,
        "lupineMappedDeviceRegister"}},
      {LUPINE_RPC_lupineMappedDeviceSync,
       {handle_manual_lupineMappedDeviceSync, "lupineMappedDeviceSync"}},
      {LUPINE_RPC_lupineMappedDeviceUnregister,
       {handle_manual_lupineMappedDeviceUnregister,
