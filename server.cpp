...
lupine_manual_handlers() {
  static const std::unordered_map<int, lupine_manual_handler> handlers = {
      ...
      {RPC_cuGraphAddExternalSemaphoresSignalNode,
       {handle_manual_cuGraphAddExternalSemaphoresSignalNode,
        "cuGraphAddExternalSemaphoresSignalNode"}},
      {RPC_cuGraphExternalSemaphoresSignalNodeGetParams,
       {handle_manual_cuGraphExternalSemaphoresSignalNodeGetParams,
        "cuGraphExternalSemaphoresSignalNodeGetParams"}},
      {RPC_cuGraphExternalSemaphoresSignalNodeSetParams,
       {handle_manual_cuGraphExternalSemaphoresSignalNodeSetParams,
        "cuGraphExternalSemaphoresSignalNodeSetParams"}},
      {RPC_cuGraphExecExternalSemaphoresSignalNodeSetParams,
       {handle_manual_cuGraphExecExternalSemaphoresSignalNodeSetParams,
        "cuGraphExecExternalSemaphoresSignalNodeSetParams"}},
      {RPC_cuGraphAddExternalSemaphoresWaitNode,
       {handle_manual_cuGraphAddExternalSemaphoresWaitNode,
        "cuGraphAddExternalSemaphoresWaitNode"}},
      {RPC_cuGraphExternalSemaphoresWaitNodeGetParams,
       {handle_manual_cuGraphExternalSemaphoresWaitNodeGetParams,
        "cuGraphExternalSemaphoresWaitNodeGetParams"}},
      {RPC_cuGraphExternalSemaphoresWaitNodeSetParams,
       {handle_manual_cuGraphExternalSemaphoresWaitNodeSetParams,
        "cuGraphExternalSemaphoresWaitNodeSetParams"}},
      {RPC_cuGraphExecExternalSemaphoresWaitNodeSetParams,
       {handle_manual_cuGraphExecExternalSemaphoresWaitNodeSetParams,
        "cuGraphExecExternalSemaphoresWaitNodeSetParams"}},
      {RPC_cuGraphAddBatchMemOpNode,
       {handle_manual_cuGraphAddBatchMemOpNode, "cuGraphAddBatchMemOpNode"}},
      {RPC_cuGraphBatchMemOpNodeGetParams,
       {handle_manual_cuGraphBatchMemOpNodeGetParams,
        "cuGraphBatchMemOpNodeGetParams"}},
      {RPC_cuGraphBatchMemOpNodeSetParams,
       {handle_manual_cuGraphBatchMemOpNodeSetParams,
        "cuGraphBatchMemOpNodeSetParams"}},
      {RPC_cuGraphExecBatchMemOpNodeSetParams,
       {handle_manual_cuGraphExecBatchMemOpNodeSetParams,
